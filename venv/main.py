...
r = tk.Tk()
summaryLabel = Label(r, text = "If this is your first time running this program, please hit the download NLTK Data button.", width = 100, wraplength = 400, justify = "left")
